...
/**
  ...
  *
  * @checksum - 8ae9d5fc62c37d36cc1e45e8aaacfef92c4fdadaa6075fa4f3ebeec652304858
  * @variables - radius=rounded-lg,accentColor=emerald,colorTemperature=neutral,spacing=2,scale=lg,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:button__input": {
    ...
    "border": true,
    "border-emerald-600": true,
    "text-emerald-600": true,
    "group-[]/repeater:shadow-sm": true,
    "group-[]/multistep:shadow-sm": true,
    "dark:border-emerald-500": true
  },
  "family:box__wrapper": {
    "inline-flex": true,
    "items-center": true,
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-emerald-500": true,
    "peer-checked:border-emerald-600": true,
    "relative": true,
    "block": true,
    "text-xl": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-emerald-50": true,
    "peer-checked:text-emerald-600": true,
    ...
    "dark:ring-offset-emerald-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-emerald-900": true,
    "dark:peer-checked:text-emerald-400": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-emerald-500": true,
    "focus-within:!border-emerald-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-neutral-700": true,
    "text-lg": true,
    "data-[is-active]:bg-emerald-100": true,
    ...
    "data-[is-active]:before:ring-emerald-500": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-emerald-100": true,
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-emerald-500": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-emerald-500": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-emerald-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-emerald-600": true
  },
  "button__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "dark:text-emerald-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-emerald-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "date__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-emerald-100": true
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-emerald-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-emerald-600": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-emerald-600": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-emerald-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-emerald-500": true,
    ...
    "[&::-moz-range-thumb]:bg-emerald-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-emerald-500": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:checked:bg-emerald-100": true,
    "group-data-[multiple]:focus:bg-emerald-100": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:group-data-[multiple]:focus:bg-emerald-800": true,
    "dark:group-data-[multiple]:checked:bg-emerald-800": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "submit__input": {
    ...
    "text-white": true,
    "!text-xl": true,
    "active:text-darkgreen": true,
    "active:bg-darkgreen": true,
    "hover:bg-darkgreen": true,
  ...
  "week__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-emerald-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-emerald-100": true
  },
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-emerald-500": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input]:selection:bg-emerald-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-emerald-600": true,
    "[&>input:focus]:border-emerald-600": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-emerald-500": true,
  ...
  "datepicker__month": {
    ...
    "focus:outline-emerald-600": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-emerald-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-emerald-600": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-emerald-600": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-emerald-500": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-neutral-600": true,
    "focus-visible:text-emerald-600": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-emerald-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
  ...
  "slider__tooltip": {
    ...
    "after:border-t-emerald-600": true,
  ...
  "toggle__track": {
    ...
    "transition-all": true,
    "bg-neutral-400": true,
    "peer-checked:bg-emerald-600": true,
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-emerald-500": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:disabled:text-emerald-500": true,
    "dark:text-emerald-500": true,
    "aria-[pressed=true]:bg-emerald-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-emerald-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-emerald-500": true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-emerald-600": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-emerald-600": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-emerald-600": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-emerald-600": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-emerald-600": true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-emerald-500": true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-emerald-600": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-emerald-600": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-emerald-600": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-emerald-600": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-emerald-600": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-lg": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-emerald-600": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-emerald-500": true,
    "dark:border-neutral-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "aria-selected:bg-emerald-100": true,
    "data-[is-active=true]:bg-emerald-100": true,
    "data-[is-active=true]:ring-emerald-200": true,
    "aria-selected:ring-emerald-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-emerald-900": true,
    "dark:aria-selected:bg-emerald-900": true,
    "dark:ring-neutral-700": true,
    "dark:data-[is-active=true]:ring-emerald-600": true,
    "dark:aria-selected:ring-emerald-600": true,
    "[&.formkit-dropZone]:bg-emerald-100": true,
    "[&.formkit-selectionDropZone]:bg-emerald-100": true,
    "[&.formkit-touchDropZone]:bg-emerald-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-emerald-100": true,
    "[&.formkit-longTouch]:bg-emerald-100": true,
    "dark:[&.formkit-dropZone]:bg-emerald-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-emerald-900": true,
    "dark:[&.formkit-touchDropZone]:bg-emerald-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-emerald-900": true,
    "dark:[&.formkit-longTouch]:bg-emerald-900": true
  },
  ...
  "transferlist__transferlistSearch": {
    ...
    "dark:border-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:selection:bg-emerald-100": true,
    "dark:selection:text-neutral-700": true,
    "dark:bg-neutral-800": true
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-emerald-600": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-emerald-600": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-emerald-600": true,
