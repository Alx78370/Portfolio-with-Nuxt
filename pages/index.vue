...
<template>
  ...
  >
    ...
    <About />
    <div class="hidden md:flex justify-center items-center group absolute inset-x-0 bottom-0">
      <LottieAnimation
  ...
  <section
    id="works"
    class="relative py-12 md:h-screen px-5 bg-[#212121] sm:px-12 md:px-32 lg:px-40 xl:px-54 xxl:px-96"
  >
    <h1 class="text-green text-5xl text-center mb-10 font-mono" data-aos="fade-down">
      Portfolio
    </h1>
    <WorksCard />
    <div class="hidden md:flex justify-center items-center group absolute inset-x-0 bottom-0">
      ...
      :autoplay="true"
      class="w-32 cursor-pointer transition-transform duration-100 group-hover:scale-125"
      @click="() => { scrollTo('#contact'); setFocus('#contact'); }"
  ...
  >
    <h1 class="text-green text-5xl text-center mb-20 font-mono" data-aos="fade-down">
      Contact
    </h1>
    <p
      data-aos="fade-right"
    ...
    <Socials />
    <div class="hidden md:flex justify-center items-center group absolute right-5 bottom-0">
      <LottieAnimation
      animationPath="https://lottie.host/e2fa6652-8b2a-4ee6-9e4f-9f1ff75c4210/sWquAIUqWR.json"
      :loop="true"
      :autoplay="true"
