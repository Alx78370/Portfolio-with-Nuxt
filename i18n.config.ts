  ...
  messages: {
    ...
    fr: {
      underConstruction: {
        ...
        message: "Revenez bientôt pour voir le site finalisé.",
      ...
      questions:
        "Des questions ? N'hésitez pas à me contacter via ce formulaire ou à me rejoindre sur mes réseaux sociaux.",
      form: {
        emailLabel: "E-mail",
        subjectLabel: "Objet",
